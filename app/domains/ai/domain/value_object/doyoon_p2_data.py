...
class DoyoonP2IlganData:
    ...
    recovery_lag_multiplier: str  # 비수치 표현 — 평균 대비 회복 속도 (예: "한결 더디게")
...
DOYOON_P2_DATA: dict[str, DoyoonP2IlganData] = {
    ...
    "갑목": DoyoonP2IlganData(
        ...
        hurt_type_2=HurtType(
            keyword="성과 평가절하",
            risk_pct="68%",
            desc="자력 성취 가치 폄하 입력 시 회복 시간이 평소보다 크게 늘어납니다.",
        ),
        intervention_drop_pct="38%",
        meters=_m(35, 60, 80, 95),
        recovery_lag_multiplier="평균보다 한결 빠르게",
        sd_avatar_asset="dy_03",
    ...
    "을목": DoyoonP2IlganData(
        hurt_type_1=HurtType(
            keyword="정성 미인지",
            risk_pct="74%",
            desc="작은 헌신 누적 케이스에서 미인지 발생률이 평소보다 크게 잡힙니다.",
        ),
        hurt_type_2=HurtType(
            keyword="혼자 남겨짐",
            risk_pct="66%",
            desc="환경 의존도가 두드러지는 케이스라 단기 부재도 큰 변동성으로 해석됩니다.",
        ),
        intervention_drop_pct="35%",
        meters=_m(25, 50, 72, 90),
        recovery_lag_multiplier="평소보다 다소 더디게",
        sd_avatar_asset="dy_03",
    ...
    "병화": DoyoonP2IlganData(
        hurt_type_1=HurtType(
            keyword="저텐션 응답",
            risk_pct="70%",
            desc="표현 빈도가 유독 높은 케이스에서 응답 격차가 거절 신호로 해석되는 빈도가 높습니다.",
        ),
        hurt_type_2=HurtType(
            keyword="입출력 불균형",
            risk_pct="65%",
        ...
        recovery_lag_multiplier="평균보다 빠르게",
        sd_avatar_asset="dy_03",
    ...
    "정화": DoyoonP2IlganData(
        hurt_type_1=HurtType(
            keyword="조용한 정성 미인지",
            risk_pct="76%",
            desc="한 사람 집중도가 두드러지는 케이스에서 미인지 시 누적 손실이 평균보다 깊게 측정됩니다.",
        ),
        hurt_type_2=HurtType(
            keyword="시선 분산 감지",
            risk_pct="62%",
            desc="단일 집중 패턴이라 시선 이동 시 위험도가 평소보다 크게 잡힙니다.",
        ),
        intervention_drop_pct="43%",
        meters=_m(18, 35, 55, 85),
        recovery_lag_multiplier="평소보다 한결 더디게",
        sd_avatar_asset="dy_03",
    ...
    "무토": DoyoonP2IlganData(
        hurt_type_1=HurtType(
            keyword="일관성 결손",
            risk_pct="68%",
            desc="안정성이 두드러지는 케이스에서 변동성 입력이 가장 큰 위험 변수로 측정됩니다.",
        ),
        hurt_type_2=HurtType(
            keyword="강제 가속 입력",
            risk_pct="71%",
    ...
    "기토": DoyoonP2IlganData(
        hurt_type_1=HurtType(
            keyword="누적 헌신 미인지",
            risk_pct="73%",
            desc="수용도가 두드러지는 케이스에서 미인지 시 자기 소진 변수가 임계점에 도달합니다.",
        ),
        hurt_type_2=HurtType(
            keyword="상대 성장 정체",
            risk_pct="67%",
    ...
    "경금": DoyoonP2IlganData(
        hurt_type_1=HurtType(
            keyword="불확실한 신호",
            risk_pct="69%",
            desc="판단 명확성이 두드러지는 케이스에서 모호한 응답 시 차단율이 평균보다 빠릅니다.",
        ),
        hurt_type_2=HurtType(
            keyword="우회 표현",
            risk_pct="64%",
            desc="직설 표현 패턴이라 우회 입력 시 신뢰 변수가 평소보다 크게 빠르게 감소합니다.",
        ),
    ...
    "신금": DoyoonP2IlganData(
        hurt_type_1=HurtType(
            keyword="작은 약속 미준수",
            risk_pct="75%",
            desc="자기 보호 강도가 두드러지는 케이스에서 신뢰 위반 시 회복 임계점이 평균보다 깊습니다.",
        ),
        hurt_type_2=HurtType(
            keyword="섬세 변수 부주의 처리",
            risk_pct="63%",
            desc="정서 깊이가 두드러지는 케이스라 부주의 입력 시 차단율이 자동 발화됩니다.",
        ),
        intervention_drop_pct="39%",
        meters=_m(17, 33, 53, 82),
        recovery_lag_multiplier="평소보다 훨씬 더디게",
        sd_avatar_asset="dy_03",
    ...
    "계수": DoyoonP2IlganData(
        hurt_type_1=HurtType(
            keyword="가속 입력",
            risk_pct="71%",
            desc="섬세함이 두드러지는 케이스라 가속 입력 시 흩어짐 응답이 자동 발화됩니다.",
        ),
        hurt_type_2=HurtType(
            keyword="잠재 신호 미인지",
            risk_pct="65%",
            desc="명시 표현이 평소보다 적은 케이스에서 미인지 시 자기 가치 변수가 평균보다 빠르게 감소합니다.",
        ),
        intervention_drop_pct="35%",
