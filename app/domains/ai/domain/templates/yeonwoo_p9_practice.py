...
PARA_3_LEAD = "이 셋을 한 달만 의식해. 그럼 네 붉은 실의 매듭이 풀리기 시작해."
PARA_3_TAIL = "작은 거 하나부터 시작하면 돼. 다 안 해도 되니까 하나씩 해."
...
METHOD_CARDS_BY_LACK: dict[str, tuple[MethodCard, MethodCard, MethodCard]] = {
    "목": (
        MethodCard("방법 1 · 색", "초록 계열 가까이 둬",
                   "목(木) 기운을 색으로 채우자. 옷, 소품, 핸드폰 배경화면도 좋아."),
        MethodCard("방법 2 · 공간", "동쪽 자리 의식해",
                   "동쪽이 목(木)의 자리야. 책상이든 침대 머리든 그 방향으로 둬."),
        MethodCard("방법 3 · 행동", "아침 산책 30분",
                   "살아있는 기운을 몸에 채우는 게 좋아. 식물, 나무, 흙 가까이하고."),
    ),
    "화": (
        MethodCard("방법 1 · 색", "빨강·주황 들여놔",
                   "화(火) 기운을 색으로 채우자. 액세서리든 포인트 컬러로든 일상에 넣는 게 좋겠지."),
        MethodCard("방법 2 · 공간", "남쪽 자리 의식해",
                   "남쪽이 화(火)의 자리야. 햇볕 잘 드는 자리에 머물러."),
        MethodCard("방법 3 · 행동", "오후 운동 30분",
                   "땀 나는 활동으로 기운을 데우는 게 좋아. 차갑게 식히지 마."),
    ),
    "토": (
        MethodCard("방법 1 · 색", "초록 계열 가까이 둬",
                   "토(土) 기운을 색으로 채우자. 옷, 소품, 화면 다 좋아."),
        MethodCard("방법 2 · 공간", "동쪽 자리 의식해",
                   "동쪽이 토(土)의 자리야. 책상이든 침대 머리든 그 방향으로 둬."),
        MethodCard("방법 3 · 행동", "아침 산책 30분",
                   "살아있는 기운을 몸에 채우는 게 좋아. 식물, 나무, 흙 가까이하고."),
    ),
    "금": (
        MethodCard("방법 1 · 색", "흰색·금속 톤 들여놔",
                   "금(金) 기운을 색으로 채우자. 단정한 흰옷, 금색 소품이 좋아."),
        MethodCard("방법 2 · 공간", "서쪽 자리 의식해",
                   "서쪽이 금(金)의 자리야. 책상이든 침대 머리든 그 방향으로 둬."),
        MethodCard("방법 3 · 행동", "공간 정리 30분",
                   "물건 다듬어서 좀 줄이자. 금속 소품이나 도구를 가까이 둬."),
    ),
    "수": (
        MethodCard("방법 1 · 색", "짙은 파랑·검정 가까이 둬",
                   "수(水) 기운을 색으로 채우자. 옷, 소품, 화면 다 좋아."),
        MethodCard("방법 2 · 공간", "북쪽 자리 의식해",
                   "북쪽이 수(水)의 자리야. 책상이든 침대 머리든 그 방향으로 둬."),
        MethodCard("방법 3 · 행동", "저녁 차 한 잔",
                   "차분한 결을 몸에 채우는 게 좋아. 물을 가까이하고 고요한 자리에 머무르자."),
    ),
}
...
LACK_HEADER_BY_LACK: dict[str, str] = {
    "목": (
        "{ohang_with_hanja}가 비어 있어. 채워야 결이 자라겠지. "
        "빈 채로 두면 인연이 들어와도 뿌리 내릴 자리가 없어."
    ),
    "화": (
        "{ohang_with_hanja}가 비어 있어. 채워야 결이 따뜻해지겠지. "
        "빈 채로 두면 인연이 와도 식어버려."
    ),
    "토": (
        "{ohang_with_hanja}가 비어 있어. 채워야 흐름이 돌 거야. "
        "빈 채로 두면 인연이 들어와도 머물 자리가 없어."
    ),
    "금": (
        "{ohang_with_hanja}가 비어 있어. 채워야 결이 분명해질 거야. "
        "빈 채로 두면 인연이 와도 흐릿하게 흘러."
    ),
    "수": (
        "{ohang_with_hanja}가 비어 있어. 채워야 결이 깊어질 거야. "
...
METHOD_BODY_BY_LACK: dict[str, str] = {
    "목": (
        "색은 녹색. 옷이든 소품이든 배경화면이든 일상에 들여놓는 게 좋아. "
        "자리는 동쪽이 좋아. 책상이든 침대 머리든 동쪽으로 돌려. "
        "행동은 아침 산책, 딱 30분이면 돼. 식물, 나무, 흙처럼 목(木) 기운이 사는 자리 가까이 다가가는 게 좋아."
    ),
    "화": (
        "색은 붉은 계열이 좋아. 포인트 컬러로 일상에 들여놔. "
        "자리는 남쪽이 좋겠지. 햇볕 잘 드는 자리에 머물러야해. "
        "오후 운동이 잘 맞고, 딱 30분이면 돼. 땀 나는 행동으로 차가운 자리를 데우는 게 좋아."
    ),
    "토": (
        "녹색. 옷이든 소품이든 배경화면이든 일상에 들여놓자. "
        "자리는 동쪽이 좋겠다. 책상이든 침대 머리든 동쪽으로 돌려. "
        "아침 산책 딱 30분이면 돼. 식물, 나무, 흙처럼 토(土) 기운이 사는 자리 가까이 다가가는 게 좋아."
    ),
    "금": (
        "색은 흰색이나 금속 색상. 단정한 옷과 금속 소품을 좀 쓰는 게 좋겠네. "
        "자리는 서쪽이 좋겠다. 책상이든 침대 머리든 서쪽으로 돌려. "
        "공간 정리가 중요한데, 하루에 딱 30분이면 돼. 물건 줄이고 결을 다듬는 자리에 머무르자."
    ),
    "수": (
        "색은 짙은 푸른색과 검정이 어울려. 옷이든 소품이든 배경화면이든 일상에 들여놔. "
        "자리는 북쪽. 책상이든 침대 머리든 북쪽으로 돌려. "
        "저녁 차 한 잔 하면서 생각을 정리하는 것도 좋겠지. 이런 식으로 물을 가까이하고 고요한 자리에 머물러봐."
    ),
}
...
ILGAN_PRACTICE_BY_ILGAN: dict[str, str] = {
    "갑목": (
        "{ilgan_with_hanja} 일간은 곧게 뻗는 사람인데, "
        "거기에 {ohang_with_hanja} 기운이 들어가야 비로소 인연이 움직여."
    ),
    "을목": (
        "{ilgan_with_hanja} 일간은 유연하게 휘어서 살아남는 사람인데, "
        "거기에 {ohang_with_hanja} 기운이 들어가야 비로소 인연이 움직여."
    ),
    "병화": (
        "{ilgan_with_hanja} 일간은 환하게 비추는 사람인데, "
        "거기에 {ohang_with_hanja} 기운이 들어가야 비로소 인연이 움직여."
    ),
    "정화": (
        "{ilgan_with_hanja} 일간은 작게 오래 비추는 사람인데, "
        "거기에 {ohang_with_hanja} 기운이 들어가야 비로소 인연이 움직여."
    ),
    "무토": (
        "{ilgan_with_hanja} 일간은 묵직하게 받쳐주는 사람인데, "
        "거기에 {ohang_with_hanja} 기운이 들어가야 비로소 인연이 움직여."
    ),
    "기토": (
        "{ilgan_with_hanja} 일간은 다정하게 받쳐주는 사람인데, "
        "거기에 {ohang_with_hanja} 기운이 들어가야 비로소 인연이 움직여."
    ),
    "경금": (
        "{ilgan_with_hanja} 일간은 단단하고 분명한 사람인데, "
        "거기에 {ohang_with_hanja} 기운이 들어가야 비로소 인연이 움직여."
    ),
    "신금": (
        "{ilgan_with_hanja} 일간은 다듬어진 정갈한 사람인데, "
        "거기에 {ohang_with_hanja} 기운이 들어가야 비로소 인연이 움직여."
    ),
    "임수": (
    ...
    "계수": (
        "{ilgan_with_hanja} 일간은 분위기로 스며드는 사람인데, "
        "거기에 {ohang_with_hanja} 기운이 들어가야 비로소 인연이 움직여."
    ),
}
